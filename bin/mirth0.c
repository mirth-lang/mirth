...
static void mwstat (void) {
 ...
 static void mwstr_transduce_step (void);
 ...
 static void mwstack_uncons (void);
 ...
 static void mwtoken_args_2_2B_ (void);
 ...
 static void mwtoken_is_param_name_3F_ (void);
 ...
 static void mwprim_type_is_physical (void);
 ...
 static void mwtype_is_physical (void);
 ...
 static void mwmeta_has_meta (void);
 static void mwvalue_type_has_meta (void);
 ...
 static void mwtype_sig_needs_fresh_stack_rest (void);
 ...
 static void mwtype_rigidify_sig_21_ (void);
 static void mwtype_rigidify_stack_21_ (void);
 static void mwtype_rigidify_21_ (void);
 static void mwtype_rigidify_value_21_ (void);
 static void mwprim_type_arity (void);
 static void mwtype_arity (void);
 static void mwtype_head (void);
 static void mwtype_max_count (void);
 static void mwmeta_trace_21_ (void);
 static void mwmeta_alloc_21_ (void);
 static void mwmeta_expand_if (void);
 static void mwmeta_expand (void);
 static void mwmeta_unify_21_ (void);
 static void mwmeta_expand_or_update_21_ (void);
 ...
 static void mwatom_arg_add_left_21_ (void);
 ...
 static void mwvar_is_physical (void);
 ...
 static void mwctx_len (void);
 static void mwctx_fresh_name_21_ (void);
 static void mwctx_make_fresh_stack_type_var_21_ (void);
 static void mwctx_make_fresh_type_var_21_ (void);
 static void mwctx_make_fresh_var_21_ (void);
 ...
 static void mwtype_elab_holes_allowed (void);
 static void mwtype_elab_ctx (void);
 static void mwtype_elab_ctx_3F_ (void);
 static void mwtype_elab_ctx_replace (void);
 static void mwelab_type_sig_21_ (void);
 static void mwelab_type_sig_params_21_ (void);
 ...
 static void mwab_build_word_arrow_21_ (void);
 ...
 static void mwelab_def_params_21_ (void);
 ...
 static void mwtypecheck_def_21_ (void);
...
static void mwtype_semifreshen_sig (void){
    mwdup();
    mwtype_sig_needs_fresh_stack_rest();
    if (pop_u64()) {
...
static void mwelab_def_21_ (void){
    ...
    mwuncons();
    mwover();
    mwtoken_run_has_dashes();
    if (pop_u64()) {
    mwList__3E_List_2B_();
    push_u64(0);
    push_fnptr(&mb_elab_def_21__3);
    do_pack_cons();
    mwunwrap_or();
    { value_t d2 = pop_value();
    mwSOME();
    ...
    case 0LL:
    do_drop();
    push_ptr("expected type signature or match case\0\0\0");
    break;
    case 1LL:
    do_pack_uncons(); do_drop();
    mwdrop();
...
static void mb_type_rigidify_stack_21__2 (void) {
    do_drop();
    mwctx_make_fresh_stack_type_var_21_();
    mwTVar();
}
static void mb_type_rigidify_stack_21__4 (void) {
    do_drop();
...
static void mb_elab_def_21__3 (void) {
    do_drop();
    mwdrop();
    push_ptr("missing def body\0\0\0");
    mwemit_fatal_error_21_();
}
static void mb_elab_def_21__4 (void) {
    do_drop();
