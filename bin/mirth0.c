...
static void mw_c99_string_21_ (void);
...
static void mw_main (void);
 ...
 static void mb_c99_external_21__20 (void);
 static void mb_c99_external_21__18 (void);
 static void mb_c99_external_21__19 (void);
 static void mb_c99_external_21__21 (void);
 static void mb_c99_external_21__22 (void);
 static void mb_c99_nest_2 (void);
 static void mb_c99_nest_3 (void);
 static void mb_c99_line_2 (void);
 static void mb_c99_line_3 (void);
 ...
 static void mb_c99_args_op_21__3 (void);
 static void mb_c99_args_op_21__5 (void);
 static void mb_c99_string_21__1 (void);
 ...
 static void mb_c99_pattern_21__3 (void);
...
mw__3B__3B_();
  push_ptr("#define push_u64(v) push_value(mku64(v))\0\0\0");

mw__3B_();
  push_ptr("#define push_i64(v) push_value(mki64(v))\0\0\0");
...
mw__3B__3B_();
  push_ptr("static void push_value(value_t x) {\0\0\0");

mw__3B_();
  push_ptr("   stack[--stack_counter] = x;\0\0\0");

mw__3B_();
  push_ptr("}\0\0\0");

mw__3B__3B_();
  push_ptr("static value_t pop_value(void) {\0\0\0");

mw__3B_();
  push_ptr("   return stack[stack_counter++];\0\0\0");

mw__3B_();
  push_ptr("}\0\0\0");

mw__3B__3B_();
  push_ptr("static value_t mku64 (u64 x) {\0\0\0");

mw__3B_();
  push_ptr("  value_t v = {.tag = VT_U64, .payload = {.vp_u64 = x}};\0\0\0");
...
mw__3B__3B_();
  push_ptr("static value_t mki64 (i64 x) {\0\0\0");

mw__3B_();
  push_ptr("  value_t v = {.tag = VT_U64, .payload = {.vp_i64 = x}};\0\0\0");
...
mw__2E_();
  push_u64(0);
  push_fnptr(&mb_c99_external_21__15);
  do_pack_cons();
mw_dip2();
  push_ptr("(\0\0\0");
...
mw_nip();
  push_u64(0);
  push_fnptr(&mb_c99_args_op_21__3);
  do_pack_cons();
mw_c99_line();
  break;
  case 8LL:
...
mw_nip();
  push_u64(0);
  push_fnptr(&mb_c99_args_op_21__5);
  do_pack_cons();
mw_c99_line();
  break;
  case 2LL:
...
mw__2E_();
  push_u64(0);
  push_fnptr(&mb_c99_string_21__1);
  do_pack_cons();
mw_str_for();
