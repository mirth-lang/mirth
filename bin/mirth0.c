...
static void mwstat (void) {
 ...
 static void mwtoken_args_3_2B_ (void);
 ...
 static void mb_token_args_3_2B__1 (void);
 static void mb_token_args_3_2B__2 (void);
...
static void mwtoken_args_3_2B_ (void){
    ...
    mwdrop();
    push_ptr("expected 3+ args\0\0\0");
    mwemit_fatal_error_21_();
    }
    mwList__3E_List_2B_();
    mwunwrap();
...
static void mwelab_type_sig_params_21_ (void){
    ...
    mwtoken_args();
    push_u64(0);
    push_fnptr(&mb_elab_type_sig_params_21__4);
    do_pack_cons();
    mwfor();
    mwswap();
      push_value(d2); }
