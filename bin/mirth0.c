...
static void mw_c99_prims_21_ (void);
...
static void mw_c99_prims_21_ (void){
    push_ptr("#define get_cell_index(v) ((usize)(((v).tag & 0x80) ? ((v).payload.vp_u64 >> (0xC0 - (u64)((v).tag))) : 0))\0\0\0\0");
    mw__3B__3B_();
    push_ptr("#define incref(v) do{ value_t w = (v); usize i = get_cell_index(w); if(i) heap[i].refs++; }while(0)\0\0\0\0");
    mw__3B__3B_();
    push_ptr("#define decref(v) do{ value_t w = (v); usize i = get_cell_index(w); if(i) { if(heap[i].refs) { heap[i].refs--; if (heap[i].refs == 0) heap_free(i); } }} while(0)\0\0\0\0");
    mw__3B__3B_();
    push_ptr("static void heap_free(usize i) {\0\0\0\0");
    mw__3B_();
    push_ptr("  cell_t *cell = heap + i;\0\0\0\0");
    mw__3B_();
    push_ptr("  cell_t contents = *cell;\0\0\0\0");
    mw__3B_();
    push_ptr("  memset(cell, 0, sizeof(cell_t));\0\0\0\0");
    mw__3B_();
    push_ptr("  cell->cdr.payload.vp_u64 = heap_next;\0\0\0\0");
    mw__3B_();
    push_ptr("  heap_next = i;\0\0\0\0");
    mw__3B_();
    push_ptr("  heap_count--;\0\0\0\0");
    mw__3B_();
    push_ptr("  if (contents.freecdr) { free(contents.cdr.payload.vp_ptr); }\0\0\0\0");
    mw__3B_();
    push_ptr("  else { decref(contents.cdr); }\0\0\0\0");
    mw__3B_();
    push_ptr("  decref(contents.car);\0\0\0\0");
    mw__3B_();
    push_ptr("}\0\0\0\0");
    mw__3B__3B_();
    push_ptr("#define decref_for_uncons(v) do{ value_t w = (v); usize i = get_cell_index(w); if(i) { if (heap[i].refs) { heap[i].refs--; if (heap[i].refs == 0) { memset(heap+i, 0, sizeof(cell_t)); heap[i].cdr.payload.vp_u64 = heap_next; heap_next = i; heap_count--; } else { cell_t cell = heap[i]; incref(cell.car); incref(cell.cdr); } } } } while(0)\0\0\0\0");
    mw__3B_();
    push_ptr("static void value_uncons(value_t val, value_t* car, value_t* cdr) {\0\0\0\0");
    mw__3B_();
    push_ptr("  switch (val.tag) {\0\0\0\0");
    mw__3B_();
    push_ptr("    case VT_U64: {\0\0\0\0");
    mw__3B_();
    push_ptr("      value_t nil = { 0 };\0\0\0\0");
    mw__3B_();
    push_ptr("      *car = nil;\0\0\0\0");
    mw__3B_();
    push_ptr("      *cdr = val;\0\0\0\0");
    mw__3B_();
    push_ptr("    } break;\0\0\0\0");
    mw__3B_();
    push_ptr("    case VT_U32: {\0\0\0\0");
    mw__3B_();
    push_ptr("      u64 vv = val.payload.vp_u64;\0\0\0\0");
    mw__3B_();
    push_ptr("      u64 lo = vv & 0xFFFFFFFF;\0\0\0\0");
    mw__3B_();
    push_ptr("      u64 hi = vv >> 32;\0\0\0\0");
    mw__3B_();
    push_ptr("      car->tag = VT_U64; car->payload.vp_u64 = hi;\0\0\0\0");
    mw__3B_();
    push_ptr("      cdr->tag = VT_U64; cdr->payload.vp_u64 = lo;\0\0\0\0");
    mw__3B_();
    push_ptr("    } break;\0\0\0\0");
    mw__3B_();
    push_ptr("    case VT_C64: {\0\0\0\0");
    mw__3B_();
    push_ptr("      cell_t* cell = heap + val.payload.vp_u64;\0\0\0\0");
    mw__3B_();
    push_ptr("      *car = cell->car;\0\0\0\0");
    mw__3B_();
    push_ptr("      *cdr = cell->cdr;\0\0\0\0");
    mw__3B_();
    push_ptr("    } break;\0\0\0\0");
    mw__3B_();
    push_ptr("    case VT_C32: {\0\0\0\0");
    mw__3B_();
    push_ptr("      u64 vv = val.payload.vp_u64;\0\0\0\0");
    mw__3B_();
    push_ptr("      u64 lo = vv & 0xFFFFFFFF;\0\0\0\0");
    ...
    push_ptr("      u64 hi = vv >> 32;\0\0\0\0");
    mw__3B_();
    push_ptr("      car->tag = VT_C64; car->payload.vp_u64 = hi;\0\0\0\0");
    mw__3B_();
    push_ptr("      cdr->tag = VT_U64; cdr->payload.vp_u64 = lo;\0\0\0\0");
    mw__3B_();
    push_ptr("    } break;\0\0\0\0");
    mw__3B_();
    push_ptr("    case VT_U21: {\0\0\0\0");
    mw__3B_();
    push_ptr("      u64 vv = val.payload.vp_u64;\0\0\0\0");
    mw__3B_();
    push_ptr("      u64 lo = vv & 0x1FFFFF;\0\0\0\0");
    mw__3B_();
    push_ptr("      u64 md = (vv >> 21) & 0x1FFFFF;\0\0\0\0");
    mw__3B_();
    push_ptr("      u64 hi = (vv >> 42) & 0x1FFFFF;\0\0\0\0");
    mw__3B_();
    push_ptr("      car->tag = VT_U32;\0\0\0\0");
    mw__3B_();
    push_ptr("      car->payload.vp_u64 = (hi << 32) | md;\0\0\0\0");
    mw__3B_();
    push_ptr("      cdr->tag = VT_U64; cdr->payload.vp_u64 = lo;\0\0\0\0");
    mw__3B_();
    push_ptr("    } break;\0\0\0\0");
    mw__3B_();
    push_ptr("    case VT_C21: {\0\0\0\0");
    mw__3B_();
    push_ptr("      u64 vv = val.payload.vp_u64;\0\0\0\0");
    mw__3B_();
    push_ptr("      u64 lo = vv & 0x1FFFFF;\0\0\0\0");
    ...
    push_ptr("      u64 hi = (vv >> 42) & 0x1FFFFF;\0\0\0\0");
    mw__3B_();
    push_ptr("      car->tag = VT_C32;\0\0\0\0");
    mw__3B_();
    push_ptr("      car->payload.vp_u64 = (hi << 32) | md;\0\0\0\0");
    mw__3B_();
    push_ptr("      cdr->tag = VT_U64; cdr->payload.vp_u64 = lo;\0\0\0\0");
    ...
    push_ptr("    } break;\0\0\0\0");
    mw__3B_();
    push_ptr("    case VT_U16: {\0\0\0\0");
    mw__3B_();
    push_ptr("      u64 vv = val.payload.vp_u64;\0\0\0\0");
    mw__3B_();
    push_ptr("      u64 lo = vv & 0xFFFF;\0\0\0\0");
    mw__3B_();
    push_ptr("      u64 y2 = (vv >> 16) & 0xFFFF;\0\0\0\0");
    mw__3B_();
    push_ptr("      u64 y1 = (vv >> 32) & 0xFFFF;\0\0\0\0");
    mw__3B_();
    push_ptr("      u64 y0 = (vv >> 48) & 0xFFFF;\0\0\0\0");
    mw__3B_();
    push_ptr("      car->tag = VT_U21;\0\0\0\0");
    mw__3B_();
    push_ptr("      car->payload.vp_u64 = (y0 << 42) | (y1 << 21) | y2;\0\0\0\0");
    mw__3B_();
    push_ptr("      cdr->tag = VT_U64; cdr->payload.vp_u64 = lo;\0\0\0\0");
    mw__3B_();
    push_ptr("    } break;\0\0\0\0");
    mw__3B_();
    push_ptr("    case VT_C16: {\0\0\0\0");
    mw__3B_();
    push_ptr("      u64 vv = val.payload.vp_u64;\0\0\0\0");
    mw__3B_();
    push_ptr("      u64 lo = vv & 0xFFFF;\0\0\0\0");
    ...
    push_ptr("      u64 y0 = (vv >> 48) & 0xFFFF;\0\0\0\0");
    mw__3B_();
    push_ptr("      car->tag = VT_C21;\0\0\0\0");
    mw__3B_();
    push_ptr("      car->payload.vp_u64 = (y0 << 42) | (y1 << 21) | y2;\0\0\0\0");
    mw__3B_();
    push_ptr("      cdr->tag = VT_U64; cdr->payload.vp_u64 = lo;\0\0\0\0");
    ...
    push_ptr("}\0\0\0\0");
    mw__3B__3B_();
    push_ptr("static bool value_has_ptr_offset (value_t v) {\0\0\0\0");
    mw__3B_();
    push_ptr("  if (v.tag == VT_C64) {\0\0\0\0");
    mw__3B_();
    push_ptr("    usize cell_index = (usize)v.payload.vp_u64;\0\0\0\0");
    mw__3B_();
    push_ptr("    struct cell_t * cell = heap + cell_index;\0\0\0\0");
    mw__3B_();
    push_ptr("    return !cell->freecdr;\0\0\0\0");
    mw__3B_();
    push_ptr("  } else {\0\0\0\0");
    mw__3B_();
    push_ptr("    return v.tag != VT_U64;\0\0\0\0");
    mw__3B_();
    push_ptr("  }\0\0\0\0");
    mw__3B_();
    push_ptr("}\0\0\0\0");
    mw__3B__3B_();
    push_ptr("static u64 value_ptr_size (value_t v) {\0\0\0\0");
    mw__3B_();
    push_ptr("  if (v.payload.vp_u64 == 0) {\0\0\0\0");
    mw__3B_();
    push_ptr("    return 0;\0\0\0\0");
    mw__3B_();
    push_ptr("  } else if (v.tag == VT_U64) {\0\0\0\0");
    mw__3B_();
    push_ptr("    return strlen(v.payload.vp_ptr);\0\0\0\0");
    mw__3B_();
    push_ptr("  } else if (value_has_ptr_offset(v)) {\0\0\0\0");
    mw__3B_();
    push_ptr("    value_t car, cdr;\0\0\0\0");
    mw__3B_();
    push_ptr("    value_uncons(v, &car, &cdr);\0\0\0\0");
    mw__3B_();
    push_ptr("    value_t car2, cdr2;\0\0\0\0");
    mw__3B_();
    push_ptr("    value_uncons(car, &car2, &cdr2);\0\0\0\0");
    mw__3B_();
    push_ptr("    u64 size = car2.payload.vp_u64;\0\0\0\0");
    mw__3B_();
    push_ptr("    u64 offset = cdr.payload.vp_u64;\0\0\0\0");
    mw__3B_();
    push_ptr("    if (size >= offset) {\0\0\0\0");
    mw__3B_();
    push_ptr("      return offset - size;\0\0\0\0");
    mw__3B_();
    push_ptr("    } else {\0\0\0\0");
    mw__3B_();
    push_ptr("      return 0;\0\0\0\0");
    ...
    push_ptr("    value_uncons(v, &car, &cdr);\0\0\0\0");
    mw__3B_();
    push_ptr("    return car.payload.vp_u64;\0\0\0\0");
    mw__3B_();
    push_ptr("  }\0\0\0\0");
    mw__3B_();
    push_ptr("}\0\0\0\0");
    mw__3B__3B_();
    push_ptr("static void* value_ptr_base (value_t v) {\0\0\0\0");
    mw__3B_();
    push_ptr("  if (value_has_ptr_offset(v)) {\0\0\0\0");
    mw__3B_();
    push_ptr("    value_t car, cdr;\0\0\0\0");
    mw__3B_();
    push_ptr("    value_uncons(v, &car, &cdr);\0\0\0\0");
    ...
    push_ptr("    value_uncons(car, &car2, &cdr2);\0\0\0\0");
    mw__3B_();
    push_ptr("    return cdr2.payload.vp_ptr;\0\0\0\0");
    mw__3B_();
    push_ptr("  } else {\0\0\0\0");
    mw__3B_();
    push_ptr("    value_t car, cdr;\0\0\0\0");
    ...
    push_ptr("    value_uncons(v, &car, &cdr);\0\0\0\0");
    mw__3B_();
    push_ptr("    return cdr.payload.vp_ptr;\0\0\0\0");
    mw__3B_();
    push_ptr("  }\0\0\0\0");
    mw__3B_();
    push_ptr("}\0\0\0\0");
    mw__3B__3B_();
    push_ptr("static i64 value_ptr_offset (value_t v) {\0\0\0\0");
    mw__3B_();
    push_ptr("  if (value_has_ptr_offset(v)) {\0\0\0\0");
    mw__3B_();
    push_ptr("    value_t car, cdr;\0\0\0\0");
    ...
    push_ptr("    value_uncons(v, &car, &cdr);\0\0\0\0");
    mw__3B_();
    push_ptr("    return cdr.payload.vp_i64;\0\0\0\0");
    mw__3B_();
    push_ptr("  } else {\0\0\0\0");
    mw__3B_();
    push_ptr("    return 0;\0\0\0\0");
    ...
    push_ptr("}\0\0\0\0");
    mw__3B__3B_();
    push_ptr("static void* value_ptr (value_t v) {\0\0\0\0");
    mw__3B_();
    push_ptr("  usize cell_index; cell_t* cell; usize offset;\0\0\0\0");
    mw__3B_();
    push_ptr("  switch (v.tag) {\0\0\0\0");
    mw__3B_();
    push_ptr("    case VT_U64: return v.payload.vp_ptr;\0\0\0\0");
    mw__3B_();
    push_ptr("    case VT_C64: \0\0\0\0");
    mw__3B_();
    push_ptr("      cell_index = (usize)v.payload.vp_u64;\0\0\0\0");
    mw__3B_();
    push_ptr("      cell = heap + cell_index;\0\0\0\0");
    mw__3B_();
    push_ptr("      if (cell->freecdr) {\0\0\0\0");
    mw__3B_();
    push_ptr("        return cell->cdr.payload.vp_ptr;\0\0\0\0");
    mw__3B_();
    push_ptr("      } else {\0\0\0\0");
    mw__3B_();
    push_ptr("        offset = (usize)cell->cdr.payload.vp_u64;\0\0\0\0");
    mw__3B_();
    push_ptr("        cell_index = (usize)cell->car.payload.vp_u64;\0\0\0\0");
    mw__3B_();
    push_ptr("        break;\0\0\0\0");
    mw__3B_();
    push_ptr("      }\0\0\0\0");
    ...
    push_ptr("     case VT_C32: \0\0\0\0");
    mw__3B_();
    push_ptr("      offset = (usize)v.payload.vp_u32;\0\0\0\0");
    mw__3B_();
    push_ptr("      cell_index = (usize)(v.payload.vp_u64 >> 32);\0\0\0\0");
    mw__3B_();
    push_ptr("      break;\0\0\0\0");
    mw__3B_();
    push_ptr("     default: \0\0\0\0");
    mw__3B_();
    push_ptr("      return (void*)0;\0\0\0\0");
    mw__3B_();
    push_ptr("  }\0\0\0\0");
    mw__3B_();
    push_ptr("  cell = heap + cell_index;\0\0\0\0");
    ...
    push_ptr("  if (cell->freecdr) {\0\0\0\0");
    mw__3B_();
    push_ptr("    char* base = cell->cdr.payload.vp_ptr;\0\0\0\0");
    mw__3B_();
    push_ptr("    return (void*)(base + offset);\0\0\0\0");
    mw__3B_();
    push_ptr("  }\0\0\0\0");
    mw__3B_();
    push_ptr("  return (void*)0;\0\0\0\0");
    ...
    push_ptr("}\0\0\0\0");
    mw__3B__3B_();
    push_ptr("#define pop_fnptr() (pop_value().payload.vp_fnptr)\0\0\0\0");
    mw__3B_();
    push_ptr("#define pop_u8() (pop_value().payload.vp_u8)\0\0\0\0");
    mw__3B_();
    push_ptr("#define pop_u16() (pop_value().payload.vp_u16)\0\0\0\0");
    mw__3B_();
    push_ptr("#define pop_u32() (pop_value().payload.vp_u32)\0\0\0\0");
    mw__3B_();
    push_ptr("#define pop_u64() (pop_value().payload.vp_u64)\0\0\0\0");
    mw__3B_();
    push_ptr("#define pop_i8() (pop_value().payload.vp_i8)\0\0\0\0");
    mw__3B_();
    push_ptr("#define pop_i16() (pop_value().payload.vp_i16)\0\0\0\0");
    mw__3B_();
    push_ptr("#define pop_i32() (pop_value().payload.vp_i32)\0\0\0\0");
    mw__3B_();
    push_ptr("#define pop_i64() (pop_value().payload.vp_i64)\0\0\0\0");
    mw__3B_();
    push_ptr("#define pop_bool() (pop_value().payload.vp_bool)\0\0\0\0");
    mw__3B_();
    push_ptr("#define pop_rawptr() (pop_value().payload.vp_ptr)\0\0\0\0");
    mw__3B__3B_();
    push_ptr("#define push_u64(v) push_value(mku64(v))\0\0\0\0");
    mw__3B_();
    push_ptr("#define push_i64(v) push_value(mki64(v))\0\0\0\0");
    mw__3B_();
    push_ptr("#define push_ptr(v) push_u64((u64)(v))\0\0\0\0");
    mw__3B_();
    push_ptr("#define push_fnptr(v) push_u64((u64)(v))\0\0\0\0");
    mw__3B_();
    push_ptr("#define push_bool(b) push_u64((u64)((bool)(b)))\0\0\0\0");
    mw__3B_();
    push_ptr("#define push_u8(b) push_u64((u64)(b))\0\0\0\0");
    mw__3B_();
    push_ptr("#define push_u16(b) push_u64((u64)(b))\0\0\0\0");
    mw__3B_();
    push_ptr("#define push_u32(b) push_u64((u64)(b))\0\0\0\0");
    mw__3B_();
    push_ptr("#define push_i8(b) push_i64((i64)(b))\0\0\0\0");
    mw__3B_();
    push_ptr("#define push_i16(b) push_i64((i64)(b))\0\0\0\0");
    mw__3B_();
    push_ptr("#define push_i32(b) push_i64((i64)(b))\0\0\0\0");
    mw__3B_();
    push_ptr("#define push_rawptr(v) push_u64((u64)(void*)(v))\0\0\0\0");
    mw__3B__3B_();
    push_ptr("static void push_value(value_t x) {\0\0\0\0");
    mw__3B_();
    push_ptr("   stack[--stack_counter] = x;\0\0\0\0");
    mw__3B_();
    push_ptr("}\0\0\0\0");
    mw__3B__3B_();
    push_ptr("static value_t pop_value(void) {\0\0\0\0");
    mw__3B_();
    push_ptr("   return stack[stack_counter++];\0\0\0\0");
    mw__3B_();
    push_ptr("}\0\0\0\0");
    mw__3B__3B_();
    push_ptr("static value_t mku64 (u64 x) {\0\0\0\0");
    mw__3B_();
    push_ptr("  value_t v = {.tag = VT_U64, .payload = {.vp_u64 = x}};\0\0\0\0");
    mw__3B_();
    push_ptr("  return v;\0\0\0\0");
    mw__3B_();
    push_ptr("}\0\0\0\0");
    mw__3B__3B_();
    push_ptr("static value_t mki64 (i64 x) {\0\0\0\0");
    mw__3B_();
    push_ptr("  value_t v = {.tag = VT_U64, .payload = {.vp_i64 = x}};\0\0\0\0");
    mw__3B_();
    push_ptr("  return v;\0\0\0\0");
    mw__3B_();
    push_ptr("}\0\0\0\0");
    mw__3B__3B_();
    push_ptr("static value_t mkcell (value_t car, value_t cdr) {\0\0\0\0");
    mw__3B_();
    push_ptr("  if ((car.payload.vp_u64 == 0) && (cdr.tag == VT_U64))\0\0\0\0");
    mw__3B_();
    push_ptr("    return cdr;\0\0\0\0");
    mw__3B_();
    push_ptr("  if (cdr.tag == VT_U64) {\0\0\0\0");
    mw__3B_();
    push_ptr("    switch (car.tag) {\0\0\0\0");
    mw__3B_();
    push_ptr("      case VT_U64: {\0\0\0\0");
    mw__3B_();
    push_ptr("        u64 x0 = car.payload.vp_u64;\0\0\0\0");
    mw__3B_();
    push_ptr("        u64 x1 = cdr.payload.vp_u64;\0\0\0\0");
    mw__3B_();
    push_ptr("        u64 y0 = x0 & 0xFFFFFFFFLL;\0\0\0\0");
    mw__3B_();
    push_ptr("        u64 y1 = x1 & 0xFFFFFFFFLL;\0\0\0\0");
    mw__3B_();
    push_ptr("        if ((x0 == y0) && (x1 == y1)) {\0\0\0\0");
    mw__3B_();
    push_ptr("          value_t r;\0\0\0\0");
    mw__3B_();
    push_ptr("          r.tag = VT_U32;\0\0\0\0");
    mw__3B_();
    push_ptr("          r.payload.vp_u64 = (y0 << 32) | y1;\0\0\0\0");
    mw__3B_();
    push_ptr("          return r;\0\0\0\0");
    mw__3B_();
    push_ptr("        }\0\0\0\0");
    mw__3B_();
    push_ptr("      } break;\0\0\0\0");
    ...
    push_ptr("      case VT_U32: {\0\0\0\0");
    mw__3B_();
    push_ptr("        u64 x0 = car.payload.vp_u64 >> 32;\0\0\0\0");
    mw__3B_();
    push_ptr("        u64 x1 = car.payload.vp_u64 & 0xFFFFFFFFLL;\0\0\0\0");
    mw__3B_();
    push_ptr("        u64 x2 = cdr.payload.vp_u64;\0\0\0\0");
    mw__3B_();
    push_ptr("        u64 y0 = x0 & 0x1FFFFFLL;\0\0\0\0");
    mw__3B_();
    push_ptr("        u64 y1 = x1 & 0x1FFFFFLL;\0\0\0\0");
    mw__3B_();
    push_ptr("        u64 y2 = x2 & 0x1FFFFFLL;\0\0\0\0");
    mw__3B_();
    push_ptr("        if ((x0 == y0) && (x1 == y1) && (x2 == y2)) {\0\0\0\0");
    mw__3B_();
    push_ptr("          value_t r;\0\0\0\0");
    mw__3B_();
    push_ptr("          r.tag = VT_U21;\0\0\0\0");
    mw__3B_();
    push_ptr("          r.payload.vp_u64 = (y0 << 42) | (y1 << 21) | y2;\0\0\0\0");
    mw__3B_();
    push_ptr("          return r;\0\0\0\0");
    mw__3B_();
    push_ptr("        }\0\0\0\0");
    ...
    push_ptr("      case VT_U21: {\0\0\0\0");
    mw__3B_();
    push_ptr("        u64 x0 = car.payload.vp_u64 >> 42;\0\0\0\0");
    mw__3B_();
    push_ptr("        u64 x1 = (car.payload.vp_u64 >> 21) & 0x1FFFFFLL;\0\0\0\0");
    mw__3B_();
    push_ptr("        u64 x2 = car.payload.vp_u64 & 0x1FFFFFLL;\0\0\0\0");
    mw__3B_();
    push_ptr("        u64 x3 = cdr.payload.vp_u64;\0\0\0\0");
    mw__3B_();
    push_ptr("        u64 y0 = x0 & 0xFFFFLL;\0\0\0\0");
    mw__3B_();
    push_ptr("        u64 y1 = x1 & 0xFFFFLL;\0\0\0\0");
    mw__3B_();
    push_ptr("        u64 y2 = x2 & 0xFFFFLL;\0\0\0\0");
    mw__3B_();
    push_ptr("        u64 y3 = x3 & 0xFFFFLL;\0\0\0\0");
    mw__3B_();
    push_ptr("        if ((x0 == y0) && (x1 == y1) && (x2 == y2) && (x3 == y3)) {\0\0\0\0");
    mw__3B_();
    push_ptr("          value_t r;\0\0\0\0");
    mw__3B_();
    push_ptr("          r.tag = VT_U16;\0\0\0\0");
    mw__3B_();
    push_ptr("          r.payload.vp_u64 = (y0 << 48) | (y1 << 32) | (y2 << 16) | y3;\0\0\0\0");
    mw__3B_();
    push_ptr("          return r;\0\0\0\0");
    mw__3B_();
    push_ptr("        }\0\0\0\0");
    ...
    push_ptr("      } break;\0\0\0\0");
    mw__3B_();
    push_ptr("      default: break;\0\0\0\0");
    mw__3B_();
    push_ptr("    }\0\0\0\0");
    mw__3B_();
    push_ptr("  }\0\0\0\0");
    mw__3B_();
    push_ptr("  if (heap_count >= HEAP_SIZE - 1) {\0\0\0\0");
    mw__3B_();
    push_ptr("    write(2, \"HEAP OVERFLOW\\n\", 14);\0\0\0\0");
    mw__3B_();
    push_ptr("    exit(1);\0\0\0\0");
    mw__3B_();
    push_ptr("  }\0\0\0\0");
    mw__3B_();
    push_ptr("  u64 cell_index = heap_next;\0\0\0\0");
    mw__3B_();
    push_ptr("  cell_t *cell = heap + cell_index;\0\0\0\0");
    mw__3B_();
    push_ptr("  while ((cell->refs > 0) && (cell_index < HEAP_SIZE)) { cell++; cell_index++; }\0\0\0\0");
    mw__3B_();
    push_ptr("  if (cell_index >= HEAP_SIZE - 1) {\0\0\0\0");
    mw__3B_();
    push_ptr("    write(2, \"HEAP OVERFLOW\\n\", 14);\0\0\0\0");
    mw__3B_();
    push_ptr("    exit(1);\0\0\0\0");
    ...
    push_ptr("  }\0\0\0\0");
    mw__3B_();
    push_ptr("  u64 saved_index = cell->cdr.payload.vp_u64;\0\0\0\0");
    mw__3B_();
    push_ptr("  heap_next = (usize)(saved_index ? saved_index : cell_index+1);\0\0\0\0");
    mw__3B_();
    push_ptr("  heap_count++;\0\0\0\0");
    mw__3B_();
    push_ptr("  cell->refs = 1;\0\0\0\0");
    mw__3B_();
    push_ptr("  cell->freecdr = false;\0\0\0\0");
    mw__3B_();
    push_ptr("  cell->car = car;\0\0\0\0");
    mw__3B_();
    push_ptr("  cell->cdr = cdr;\0\0\0\0");
    mw__3B_();
    push_ptr("  value_t v = {0};\0\0\0\0");
    mw__3B_();
    push_ptr("  v.tag = VT_C64;\0\0\0\0");
    mw__3B_();
    push_ptr("  v.payload.vp_u64 = cell_index;\0\0\0\0");
    mw__3B_();
    push_ptr("  return v;\0\0\0\0");
    mw__3B_();
    push_ptr("}\0\0\0\0");
    mw__3B__3B_();
    push_ptr("static value_t mkcell_raw (value_t car, value_t cdr) {\0\0\0\0");
    mw__3B_();
    push_ptr("  u64 cell_index = heap_next;\0\0\0\0");
    mw__3B_();
    push_ptr("  cell_t *cell = heap + cell_index;\0\0\0\0");
    ...
    push_ptr("}\0\0\0\0");
    mw__3B__3B_();
    push_ptr("static value_t mkcell_freecdr (value_t car, value_t cdr) {\0\0\0\0");
    mw__3B_();
    push_ptr("  if (heap_count >= HEAP_SIZE - 1) {\0\0\0\0");
    mw__3B_();
    push_ptr("    write(2, \"HEAP OVERFLOW\\n\", 14);\0\0\0\0");
    ...
    push_ptr("  cell->refs = 1;\0\0\0\0");
    mw__3B_();
    push_ptr("  cell->freecdr = true;\0\0\0\0");
    mw__3B_();
    push_ptr("  cell->car = car;\0\0\0\0");
    mw__3B_();
    push_ptr("  cell->cdr = cdr;\0\0\0\0");
    ...
    push_ptr("}\0\0\0\0");
    mw__3B__3B_();
    push_ptr("static void do_pack_uncons(void) {\0\0\0\0");
    mw__3B_();
    push_ptr("  value_t car, cdr, val;\0\0\0\0");
    mw__3B_();
    push_ptr("  val = pop_value();\0\0\0\0");
    mw__3B_();
    push_ptr("  value_uncons(val, &car, &cdr);\0\0\0\0");
    mw__3B_();
    push_ptr("  push_value(car); push_value(cdr);\0\0\0\0");
    mw__3B_();
    push_ptr("  if (val.tag == VT_C64) {\0\0\0\0");
    mw__3B_();
    push_ptr("    decref_for_uncons(val);\0\0\0\0");
    mw__3B_();
    push_ptr("  }\0\0\0\0");
    mw__3B_();
    push_ptr("}\0\0\0\0");
    mw__3B__3B_();
    push_ptr("#define get_value_tag(v) (((v).tag == VT_U64) ? (v).payload.vp_i64 : (((v).tag == VT_C64) ? (heap[(v).payload.vp_u64].cdr.payload.vp_i64) : (i64)((v).payload.vp_u64 & 0xFFFF)))\0\0\0\0");
    mw__3B_();
    push_ptr("#define get_top_data_tag() (get_value_tag(stack[stack_counter]))\0\0\0\0");
    mw__3B_();
    push_ptr("#define value_cmp(v1,v2) ((((v1).tag == VT_U64) && ((v2).tag == VT_U64)) ? ((v1).payload.vp_i64 - (v2).payload.vp_i64) : value_cmp_hard((v1), (v2)))\0\0\0\0");
    mw__3B__3B_();
    push_ptr("static i64 value_cmp_hard(value_t v1, value_t v2) {\0\0\0\0");
    mw__3B_();
    push_ptr("  while(1) {\0\0\0\0");
    mw__3B_();
    push_ptr("    i64 t1 = get_value_tag(v1);\0\0\0\0");
    mw__3B_();
    push_ptr("    i64 t2 = get_value_tag(v2);\0\0\0\0");
    mw__3B_();
    push_ptr("    if (t1 < t2) return -1;\0\0\0\0");
    mw__3B_();
    push_ptr("    if (t1 > t2) return 1;\0\0\0\0");
    mw__3B_();
    push_ptr("    if ((v1.tag == VT_U64) && (v2.tag == VT_U64)) return 0;\0\0\0\0");
    mw__3B_();
    push_ptr("    value_t v1car, v1cdr, v2car, v2cdr;\0\0\0\0");
    mw__3B_();
    push_ptr("    value_uncons(v1, &v1car, &v1cdr);\0\0\0\0");
    mw__3B_();
    push_ptr("    value_uncons(v2, &v2car, &v2cdr);\0\0\0\0");
    mw__3B_();
    push_ptr("    i64 cdrcmp = value_cmp(v1cdr, v2cdr);\0\0\0\0");
    mw__3B_();
    push_ptr("    if (cdrcmp != 0) return cdrcmp;\0\0\0\0");
    mw__3B_();
    push_ptr("    v1 = v1car; v2 = v2car;\0\0\0\0");
    mw__3B_();
    push_ptr("  }\0\0\0\0");
    mw__3B_();
    push_ptr("}\0\0\0\0");
    mw__3B__3B_();
    push_ptr("#define value_eq(v1,v2) (((v1).tag == (v2).tag) && (((v1).payload.vp_u64 == (v2).payload.vp_u64) || (((v1).tag & 0x80) && value_eq_hard((v1),(v2)))))\0\0\0\0");
    mw__3B__3B_();
    push_ptr("static bool value_eq_hard(value_t v1, value_t v2) {\0\0\0\0");
    mw__3B_();
    push_ptr("  usize c1_index, c2_index; cell_t *c1, *c2;\0\0\0\0");
    mw__3B_();
    push_ptr("  while (1) {\0\0\0\0");
    mw__3B_();
    push_ptr("    if (v1.tag != v2.tag) return false;\0\0\0\0");
    mw__3B_();
    push_ptr("    if (v1.payload.vp_u64 == v2.payload.vp_u64) return true;\0\0\0\0");
    mw__3B_();
    push_ptr("    switch (v1.tag) {\0\0\0\0");
    mw__3B_();
    push_ptr("      case VT_U64: return false;\0\0\0\0");
    mw__3B_();
    push_ptr("      case VT_U32: return false;\0\0\0\0");
    mw__3B_();
    push_ptr("      case VT_U21: return false;\0\0\0\0");
    mw__3B_();
    push_ptr("      case VT_U16: return false;\0\0\0\0");
    mw__3B_();
    push_ptr("      case VT_C64:\0\0\0\0");
    mw__3B_();
    push_ptr("         c1_index = (usize)v1.payload.vp_u64;\0\0\0\0");
    mw__3B_();
    push_ptr("         c2_index = (usize)v2.payload.vp_u64;\0\0\0\0");
    mw__3B_();
    push_ptr("         break;\0\0\0\0");
    mw__3B_();
    push_ptr("      case VT_C32:\0\0\0\0");
    mw__3B_();
    push_ptr("         if (v1.payload.vp_u32 != v2.payload.vp_u32) return false;\0\0\0\0");
    mw__3B_();
    push_ptr("         c1_index = (usize)(v1.payload.vp_u64 >> 32);\0\0\0\0");
    mw__3B_();
    push_ptr("         c2_index = (usize)(v2.payload.vp_u64 >> 32);\0\0\0\0");
    mw__3B_();
    push_ptr("         break;\0\0\0\0");
    mw__3B_();
    push_ptr("      case VT_C21:\0\0\0\0");
    mw__3B_();
    push_ptr("         if (  (v1.payload.vp_u64 & 0x03FFFFFFFFFF)\0\0\0\0");
    mw__3B_();
    push_ptr("          != (v2.payload.vp_u64 & 0x03FFFFFFFFFF)) return false;\0\0\0\0");
    mw__3B_();
    push_ptr("         c1_index = (usize)(v1.payload.vp_u64 >> 42);\0\0\0\0");
    mw__3B_();
    push_ptr("         c2_index = (usize)(v2.payload.vp_u64 >> 42);\0\0\0\0");
    mw__3B_();
    push_ptr("         break;\0\0\0\0");
    mw__3B_();
    push_ptr("      case VT_C16:\0\0\0\0");
    mw__3B_();
    push_ptr("         if (  (v1.payload.vp_u64 & 0xFFFFFFFFFFFF)\0\0\0\0");
    mw__3B_();
    push_ptr("          != (v2.payload.vp_u64 & 0xFFFFFFFFFFFF)) return false;\0\0\0\0");
    mw__3B_();
    push_ptr("         c1_index = (usize)(v1.payload.vp_u64 >> 48);\0\0\0\0");
    mw__3B_();
    push_ptr("         c2_index = (usize)(v2.payload.vp_u64 >> 48);\0\0\0\0");
    mw__3B_();
    push_ptr("         break;\0\0\0\0");
    mw__3B_();
    push_ptr("    }\0\0\0\0");
    mw__3B_();
    push_ptr("    c1 = heap + c1_index;\0\0\0\0");
    mw__3B_();
    push_ptr("    c2 = heap + c2_index;\0\0\0\0");
    mw__3B_();
    push_ptr("    if (!value_eq(c1->cdr, c2->cdr)) return false;\0\0\0\0");
    mw__3B_();
    push_ptr("    v1 = c1->car; v2 = c2->car;\0\0\0\0");
    mw__3B_();
    push_ptr("  }\0\0\0\0");
    mw__3B_();
    push_ptr("}\0\0\0\0");
    mw__3B__3B_();
    push_ptr("#define do_run() do { do_pack_uncons(); fnptr fp = pop_fnptr(); fp(); } while(0)\0\0\0\0");
    mw__3B_();
    mw_PRIM_CORE_ID();
    mw__2E_pm();
    push_ptr("0\0\0\0\0");
    ...
    mw_PRIM_CORE_DUP();
    mw__2E_pm();
    push_ptr("do{ value_t v = stack[stack_counter]; push_value(v); incref(v); } while(0)\0\0\0\0");
    mw__3B__3B_();
    push_ptr("#define do_drop() decref(pop_value())\0\0\0\0");
    mw__3B_();
    mw_PRIM_CORE_DROP();
    mw__2E_pm();
    push_ptr("do_drop()\0\0\0\0");
    mw__3B__3B_();
    push_ptr("#define do_swap() do{ value_t x = stack[stack_counter]; stack[stack_counter] = stack[stack_counter+1]; stack[stack_counter+1] = x; } while(0)\0\0\0\0");
    mw__3B_();
    mw_PRIM_CORE_SWAP();
    mw__2E_pm();
    push_ptr("do_swap()\0\0\0\0");
    mw__3B__3B_();
    mw_PRIM_CORE_DIP();
    mw__2E_p();
    push_ptr(" {\0\0\0\0");
    mw__3B_();
    push_ptr("  value_t f = pop_value();\0\0\0\0");
    mw__3B_();
    push_ptr("  value_t x = pop_value();\0\0\0\0");
    mw__3B_();
    push_ptr("  push_value(f);\0\0\0\0");
    mw__3B_();
    push_ptr("  do_run();\0\0\0\0");
    mw__3B_();
    push_ptr("  push_value(x);\0\0\0\0");
    mw__3B_();
    push_ptr("}\0\0\0\0");
    mw__3B__3B_();
    mw_PRIM_CORE_IF();
    ...
    push_ptr(" {\0\0\0\0");
    mw__3B_();
    push_ptr("  value_t else_branch = pop_value();\0\0\0\0");
    mw__3B_();
    push_ptr("  value_t then_branch = pop_value();\0\0\0\0");
    mw__3B_();
    push_ptr("  bool b = pop_bool();\0\0\0\0");
    mw__3B_();
    push_ptr("  if (b) {\0\0\0\0");
    mw__3B_();
    push_ptr("    push_value(then_branch);\0\0\0\0");
    mw__3B_();
    push_ptr("    decref(else_branch);\0\0\0\0");
    mw__3B_();
    push_ptr("  } else {\0\0\0\0");
    mw__3B_();
    push_ptr("    push_value(else_branch);\0\0\0\0");
    mw__3B_();
    push_ptr("    decref(then_branch);\0\0\0\0");
    mw__3B_();
    push_ptr("  }\0\0\0\0");
    mw__3B_();
    push_ptr("  do_run();\0\0\0\0");
    ...
    push_ptr(" {\0\0\0\0");
    mw__3B_();
    push_ptr("  value_t body = pop_value();\0\0\0\0");
    mw__3B_();
    push_ptr("  value_t cond = pop_value();\0\0\0\0");
    mw__3B_();
    push_ptr("  while(1) {\0\0\0\0");
    mw__3B_();
    push_ptr("    push_value(cond); incref(cond); do_run();\0\0\0\0");
    mw__3B_();
    push_ptr("    bool b = pop_bool();\0\0\0\0");
    mw__3B_();
    push_ptr("    if (!b) break;\0\0\0\0");
    mw__3B_();
    push_ptr("    push_value(body); incref(body); do_run();\0\0\0\0");
    mw__3B_();
    push_ptr("  }\0\0\0\0");
    mw__3B_();
    push_ptr("  decref(cond); decref(body);\0\0\0\0");
    mw__3B_();
    push_ptr("}\0\0\0\0");
    mw__3B__3B_();
    mw_PRIM_INT_ADD();
    mw__2E_pm();
    push_ptr("do { stack[stack_counter+1].payload.vp_u64 += stack[stack_counter].payload.vp_u64; stack_counter++; } while(0)\0\0\0\0");
    mw__3B_();
    mw_PRIM_INT_SUB();
    mw__2E_pm();
    push_ptr("do { stack[stack_counter+1].payload.vp_u64 -= stack[stack_counter].payload.vp_u64; stack_counter++; } while(0)\0\0\0\0");
    ...
    mw_PRIM_INT_MUL();
    mw__2E_pm();
    push_ptr("do { stack[stack_counter+1].payload.vp_i64 *= stack[stack_counter].payload.vp_i64; stack_counter++; } while(0)\0\0\0\0");
    mw__3B_();
    mw_PRIM_INT_DIV();
    mw__2E_pm();
    push_ptr("do { i64 a = stack[stack_counter+1].payload.vp_i64; i64 b = stack[stack_counter].payload.vp_i64; i64 r = a % b; i64 q = a / b; if (((a < 0) ^ (b < 0)) && r) q--; stack_counter++; stack[stack_counter].payload.vp_i64 = q; } while(0)\0\0\0\0");
    mw__3B_();
    mw_PRIM_INT_MOD();
    mw__2E_pm();
    push_ptr("do { i64 a = stack[stack_counter+1].payload.vp_i64; i64 b = stack[stack_counter].payload.vp_i64; i64 r = a % b; if (((a < 0) ^ (b < 0)) && r) r += b; stack_counter++; stack[stack_counter].payload.vp_i64 = r; } while(0)\0\0\0\0");
    mw__3B_();
    mw_PRIM_INT_AND();
    mw__2E_pm();
    push_ptr("do { stack[stack_counter+1].payload.vp_u64 &= stack[stack_counter].payload.vp_u64; stack_counter++; } while(0)\0\0\0\0");
    ...
    mw_PRIM_VALUE_EQ();
    mw__2E_pm();
    push_ptr(" do { value_t v2 = pop_value(); value_t v1 = pop_value(); push_bool(value_eq(v1, v2)); decref(v1); decref(v2); } while(0)\0\0\0\0");
    mw__3B__3B_();
    mw_PRIM_VALUE_LT();
    mw__2E_pm();
    push_ptr(" do { value_t v2 = pop_value(); value_t v1 = pop_value(); push_bool(value_cmp(v1, v2) < 0); decref(v1); decref(v2); } while(0)\0\0\0\0");
    mw__3B__3B_();
    mw_PRIM_VALUE_LE();
    mw__2E_pm();
    push_ptr(" do { value_t v2 = pop_value(); value_t v1 = pop_value(); push_bool(value_cmp(v1, v2) <= 0); decref(v1); decref(v2); } while(0)\0\0\0\0");
    ...
    push_ptr(" {\0\0\0\0");
    mw__3B_();
    push_ptr("  usize n = (usize)pop_u64();\0\0\0\0");
    mw__3B_();
    push_ptr("  value_t vp = pop_value();\0\0\0\0");
    mw__3B_();
    push_ptr("  void* p = value_ptr(vp);\0\0\0\0");
    mw__3B_();
    push_ptr("  int f = (int)pop_i64();\0\0\0\0");
    mw__3B_();
    push_ptr("  push_i64((i64)write(f, p, n));\0\0\0\0");
    mw__3B_();
    push_ptr("  decref(vp);\0\0\0\0");
    mw__3B_();
    push_ptr("}\0\0\0\0");
    mw__3B__3B_();
    mw_PRIM_POSIX_READ();
    ...
    push_ptr("  int f = (int)pop_i64();\0\0\0\0");
    mw__3B_();
    push_ptr("  push_i64((i64)read(f,p,n));\0\0\0\0");
    mw__3B_();
    push_ptr("  decref(vp);\0\0\0\0");
    mw__3B_();
    push_ptr("}\0\0\0\0");
    ...
    push_ptr(" {\0\0\0\0");
    mw__3B_();
    push_ptr("  int m = (int)pop_i64();\0\0\0\0");
    mw__3B_();
    push_ptr("  int f = (int)pop_i64();\0\0\0\0");
    mw__3B_();
    push_ptr("  value_t vp = pop_value();\0\0\0\0");
    ...
    push_ptr("  void* p = value_ptr(vp);\0\0\0\0");
    mw__3B_();
    push_ptr("  push_i64((i64)open(p,f,m));\0\0\0\0");
    mw__3B_();
    push_ptr("  decref(vp);\0\0\0\0");
    mw__3B_();
    push_ptr("}\0\0\0\0");
    ...
    push_ptr(" {\0\0\0\0");
    mw__3B_();
    push_ptr("  int x = (int)pop_i64();\0\0\0\0");
    mw__3B_();
    push_ptr("  push_i64((i64)close(x));\0\0\0\0");
    mw__3B_();
    push_ptr("}\0\0\0\0");
    mw__3B__3B_();
    mw_PRIM_POSIX_EXIT();
    ...
    push_ptr(" {\0\0\0\0");
    mw__3B_();
    push_ptr("  #ifdef MIRTH_WINDOWS\0\0\0\0");
    mw__3B_();
    push_ptr("  pop_value(); pop_value(); pop_value(); pop_value();\0\0\0\0");
    mw__3B_();
    push_ptr("  usize b = (usize)pop_u64();\0\0\0\0");
    mw__3B_();
    push_ptr("  pop_value();\0\0\0\0");
    mw__3B_();
    push_ptr("  push_ptr(malloc(b));\0\0\0\0");
    mw__3B_();
    push_ptr("  #else\0\0\0\0");
    mw__3B_();
    push_ptr("  int f = (int)pop_i64();\0\0\0\0");
    mw__3B_();
    push_ptr("  int e = (int)pop_i64();\0\0\0\0");
    mw__3B_();
    push_ptr("  int d = (int)pop_i64();\0\0\0\0");
    mw__3B_();
    push_ptr("  int c = (int)pop_i64();\0\0\0\0");
    mw__3B_();
    push_ptr("  usize b = (usize)pop_u64();\0\0\0\0");
    mw__3B_();
    push_ptr("  value_t va = pop_value();\0\0\0\0");
    mw__3B_();
    push_ptr("  void* a = value_ptr(va);\0\0\0\0");
    mw__3B_();
    push_ptr("  void* p = mmap(a,b,c,d,e,f);\0\0\0\0");
    mw__3B_();
    push_ptr("  push_ptr(p);\0\0\0\0");
    mw__3B_();
    push_ptr("  decref(va);\0\0\0\0");
    mw__3B_();
    push_ptr("  #endif\0\0\0\0");
    mw__3B_();
    push_ptr("}\0\0\0\0");
    mw__3B__3B_();
    push_ptr("static void do_debug(void) {\0\0\0\0");
    mw__3B_();
    push_ptr("  write(2, \"??\", 2);\0\0\0\0");
    mw__3B_();
    push_ptr("  char c[32] = {0};\0\0\0\0");
    mw__3B_();
    push_ptr("  char* cp;\0\0\0\0");
    mw__3B_();
    push_ptr("  usize n;\0\0\0\0");
    mw__3B_();
    push_ptr("  i64 x; i64 y;\0\0\0\0");
    mw__3B_();
    push_ptr("  for (long i = STACK_SIZE-1; i >= (long)stack_counter; i--) {\0\0\0\0");
    mw__3B_();
    push_ptr("    cp = c+30;\0\0\0\0");
    mw__3B_();
    push_ptr("    x = stack[i].payload.vp_i64;\0\0\0\0");
    mw__3B_();
    push_ptr("    n = 1;\0\0\0\0");
    mw__3B_();
    push_ptr("    y = x; if (x < 0) { x = -x; }\0\0\0\0");
    mw__3B_();
    push_ptr("    do { *cp-- = '0' + (x % 10); x /= 10; n++; } while(x);\0\0\0\0");
    mw__3B_();
    push_ptr("    if (y < 0) { *cp-- = '-'; n++; } \0\0\0\0");
    mw__3B_();
    push_ptr("    *cp = ' ';\0\0\0\0");
    mw__3B_();
    push_ptr("    write(2, cp, n);\0\0\0\0");
    mw__3B_();
    push_ptr("  }\0\0\0\0");
    mw__3B_();
    push_ptr("  write(2, \"\\n\", 1);\0\0\0\0");
    ...
    mw_PRIM_CORE_DEBUG();
    mw__2E_pm();
    push_ptr("do_debug()\0\0\0\0");
    mw__3B__3B_();
    mw_PRIM_VALUE_GET();
    mw__2E_pm();
    push_ptr("do { value_t vp = pop_value(); value_t* p = value_ptr(vp); push_value(*p); incref(*p); decref(vp); } while(0)\0\0\0\0");
    mw__3B_();
    mw_PRIM_INT_GET();
    mw__2E_pm();
    push_ptr("do { value_t vp = pop_value(); i64* p = value_ptr(vp); push_i64(*p); decref(vp); } while(0)\0\0\0\0");
    mw__3B_();
    mw_PRIM_PTR_GET();
    mw__2E_pm();
    push_ptr("do { value_t vp = pop_value(); void** p = value_ptr(vp); push_ptr(*p); decref(vp); } while(0)\0\0\0\0");
    mw__3B_();
    mw_PRIM_U8_GET();
    mw__2E_pm();
    push_ptr("do { value_t vp = pop_value(); u8* p = value_ptr(vp); push_u8(*p); decref(vp); } while(0)\0\0\0\0");
    mw__3B_();
    mw_PRIM_U16_GET();
    mw__2E_pm();
    push_ptr("do { value_t vp = pop_value(); u16* p = value_ptr(vp); push_u16(*p); decref(vp); } while(0)\0\0\0\0");
    mw__3B_();
    mw_PRIM_U32_GET();
    mw__2E_pm();
    push_ptr("do { value_t vp = pop_value(); u32* p = value_ptr(vp); push_u32(*p); decref(vp); } while(0)\0\0\0\0");
    mw__3B_();
    mw_PRIM_U64_GET();
    mw__2E_pm();
    push_ptr("do { value_t vp = pop_value(); u64* p = value_ptr(vp); push_u64(*p); decref(vp); } while(0)\0\0\0\0");
    mw__3B_();
    mw_PRIM_I8_GET();
    mw__2E_pm();
    push_ptr("do { value_t vp = pop_value(); i8* p = value_ptr(vp); push_i8(*p); decref(vp); } while(0)\0\0\0\0");
    mw__3B_();
    mw_PRIM_I16_GET();
    mw__2E_pm();
    push_ptr("do { value_t vp = pop_value(); i16* p = value_ptr(vp); push_i16(*p); decref(vp); } while(0)\0\0\0\0");
    mw__3B_();
    mw_PRIM_I32_GET();
    mw__2E_pm();
    push_ptr("do { value_t vp = pop_value(); i32* p = value_ptr(vp); push_i32(*p); decref(vp); } while(0)\0\0\0\0");
    mw__3B_();
    mw_PRIM_I64_GET();
    mw__2E_pm();
    push_ptr("do { value_t vp = pop_value(); i64* p = value_ptr(vp); push_i64(*p); decref(vp); } while(0)\0\0\0\0");
    ...
    mw_PRIM_INT_SET();
    mw__2E_pm();
    push_ptr("do { value_t vp = pop_value(); i64* p = value_ptr(vp); *p = pop_i64(); decref(vp); } while(0)\0\0\0\0");
    mw__3B_();
    mw_PRIM_U8_SET();
    mw__2E_pm();
    push_ptr("do { value_t vp = pop_value(); u8* p = value_ptr(vp); *p = pop_u8(); decref(vp); } while(0)\0\0\0\0");
    mw__3B_();
    mw_PRIM_U16_SET();
    mw__2E_pm();
    push_ptr("do { value_t vp = pop_value(); u16* p = value_ptr(vp); *p = pop_u16(); decref(vp); } while(0)\0\0\0\0");
    mw__3B_();
    mw_PRIM_U32_SET();
    mw__2E_pm();
    push_ptr("do { value_t vp = pop_value(); u32* p = value_ptr(vp); *p = pop_u32(); decref(vp); } while(0)\0\0\0\0");
    mw__3B_();
    mw_PRIM_U64_SET();
    mw__2E_pm();
    push_ptr("do { value_t vp = pop_value(); u64* p = value_ptr(vp); *p = pop_u64(); decref(vp); } while(0)\0\0\0\0");
    mw__3B_();
    mw_PRIM_I8_SET();
    mw__2E_pm();
    push_ptr("do { value_t vp = pop_value(); i8* p = value_ptr(vp); *p = pop_i8(); decref(vp); } while(0)\0\0\0\0");
    mw__3B_();
    mw_PRIM_I16_SET();
    mw__2E_pm();
    push_ptr("do { value_t vp = pop_value(); i16* p = value_ptr(vp); *p = pop_i16(); decref(vp); } while(0)\0\0\0\0");
    mw__3B_();
    mw_PRIM_I32_SET();
    mw__2E_pm();
    push_ptr("do { value_t vp = pop_value(); i32* p = value_ptr(vp); *p = pop_i32(); decref(vp); } while(0)\0\0\0\0");
    mw__3B_();
    mw_PRIM_I64_SET();
    mw__2E_pm();
    push_ptr("do { value_t vp = pop_value(); i64* p = value_ptr(vp); *p = pop_i64(); decref(vp); } while(0)\0\0\0\0");
    ...
    mw_PRIM_PTR_SET();
    mw__2E_pm();
    push_ptr("do { value_t vp = pop_value(); value_t vx = pop_value(); void** p = value_ptr(vp); *p = value_ptr(vx); decref(vp); decref(vx); } while(0)\0\0\0\0");
    mw__3B_();
    mw_PRIM_VALUE_SET();
    mw__2E_pm();
    push_ptr("do { value_t vp = pop_value(); value_t vx = pop_value(); value_t* p = value_ptr(vp); value_t old = *p; *p = vx; decref(old); decref(vp); } while(0)\0\0\0\0");
    mw__3B_();
    push_ptr("#if defined(MIRTH_WINDOWS)\0\0\0\0");
    mw__3B_();
    mw_PRIM_SYS_OS();
    mw__2E_pm();
    push_ptr("push_u64(\0\0\0\0");
    ...
    push_ptr(")\0\0\0\0");
    mw__3B_();
    push_ptr("#elif defined(MIRTH_LINUX)\0\0\0\0");
    mw__3B_();
    mw_PRIM_SYS_OS();
    mw__2E_pm();
    push_ptr("push_u64(\0\0\0\0");
    ...
    push_ptr(")\0\0\0\0");
    mw__3B_();
    push_ptr("#elif defined(MIRTH_MACOS)\0\0\0\0");
    mw__3B_();
    mw_PRIM_SYS_OS();
    mw__2E_pm();
    push_ptr("push_u64(\0\0\0\0");
    ...
    push_ptr("  value_t vp = pop_value();\0\0\0\0");
    mw__3B_();
    push_ptr("  i64 y = pop_i64();\0\0\0\0");
    mw__3B_();
    push_ptr("  if (vp.tag == VT_U64) {\0\0\0\0");
    mw__3B_();
    push_ptr("    push_i64(y + vp.payload.vp_i64);\0\0\0\0");
    mw__3B_();
    push_ptr("  } else if (value_has_ptr_offset(vp)) {\0\0\0\0");
    mw__3B_();
    push_ptr("    value_t car, cdr;\0\0\0\0");
    mw__3B_();
    push_ptr("    value_uncons(vp, &car, &cdr);\0\0\0\0");
    mw__3B_();
    push_ptr("    cdr.payload.vp_i64 += y;\0\0\0\0");
    mw__3B_();
    push_ptr("    push_value(mkcell(car, cdr));\0\0\0\0");
    mw__3B_();
    push_ptr("  } else {\0\0\0\0");
    mw__3B_();
    push_ptr("    value_t vy = { .tag = VT_U64, .payload = { .vp_i64 = y } };\0\0\0\0");
    mw__3B_();
    push_ptr("    push_value(mkcell(vp, vy));\0\0\0\0");
    mw__3B_();
    push_ptr("  }\0\0\0\0");
    mw__3B_();
    push_ptr("}\0\0\0\0");
    ...
    mw_PRIM_BOOL_TRUE();
    mw__2E_pm();
    push_ptr("push_bool(true)\0\0\0\0");
    mw__3B_();
    mw_PRIM_BOOL_FALSE();
    mw__2E_pm();
    push_ptr("push_bool(false)\0\0\0\0");
    mw__3B_();
    mw_PRIM_BOOL_AND();
    mw__2E_pm();
    push_ptr("do { stack[stack_counter+1].payload.vp_u64 = stack[stack_counter+1].payload.vp_u64 && stack[stack_counter].payload.vp_u64; stack_counter++; } while(0)\0\0\0\0");
    mw__3B_();
    mw_PRIM_BOOL_OR();
    mw__2E_pm();
    push_ptr("do { stack[stack_counter+1].payload.vp_u64 = stack[stack_counter+1].payload.vp_u64 || stack[stack_counter].payload.vp_u64; stack_counter++; } while(0)\0\0\0\0");
    ...
    mw_PRIM_SYS_ARGC();
    mw__2E_pm();
    push_ptr("push_i64(global_argc)\0\0\0\0");
    mw__3B_();
    mw_PRIM_SYS_ARGV();
    mw__2E_pm();
    push_ptr("push_ptr(global_argv)\0\0\0\0");
    mw__3B_();
    mw_PRIM_PTR_SIZE();
    mw__2E_pm();
    push_ptr("push_u64((u64)sizeof(void*))\0\0\0\0");
    mw__3B_();
    mw_PRIM_PTR_ALLOC();
    mw__2E_p();
    push_ptr(" {\0\0\0\0");
    mw__3B_();
    push_ptr("  i64 psize = pop_i64();\0\0\0\0");
    mw__3B_();
    push_ptr("  if (psize > 0) {\0\0\0\0");
    mw__3B_();
    push_ptr("    usize size = (usize)psize;\0\0\0\0");
    mw__3B_();
    push_ptr("    void* ptr = calloc(1,size);\0\0\0\0");
    mw__3B_();
    push_ptr("    value_t vsize = { .tag = VT_U64, .payload = { .vp_i64 = psize } };\0\0\0\0");
    mw__3B_();
    push_ptr("    value_t vptr = { .tag = VT_U64, .payload = { .vp_ptr = ptr } };\0\0\0\0");
    mw__3B_();
    push_ptr("    value_t v = mkcell_freecdr(vsize, vptr);\0\0\0\0");
    mw__3B_();
    push_ptr("    push_value(v);\0\0\0\0");
    mw__3B_();
    push_ptr("  } else {\0\0\0\0");
    mw__3B_();
    ...
    push_ptr("}\0\0\0\0");
    mw__3B__3B_();
    push_ptr("static void* alloc_but_copy (usize dstn, void* src, usize srcn) {\0\0\0\0");
    mw__3B_();
    push_ptr("  void* dst = calloc(1,dstn);\0\0\0\0");
    mw__3B_();
    push_ptr("  if (src) {\0\0\0\0");
    mw__3B_();
    push_ptr("    usize cpyn = (dstn > srcn) ? srcn : dstn;\0\0\0\0");
    mw__3B_();
    push_ptr("    memcpy(dst, src, cpyn);\0\0\0\0");
    mw__3B_();
    push_ptr("  }\0\0\0\0");
    mw__3B_();
    push_ptr("  return dst;\0\0\0\0");
    mw__3B_();
    push_ptr("}\0\0\0\0");
    mw__3B_();
    mw_PRIM_PTR_REALLOC();
    ...
    push_ptr("  i64 psize = pop_i64();\0\0\0\0");
    mw__3B_();
    push_ptr("  value_t vptr = pop_value();\0\0\0\0");
    mw__3B_();
    push_ptr("  if (psize <= 0) { \0\0\0\0");
    mw__3B_();
    push_ptr("    decref(vptr);\0\0\0\0");
    mw__3B_();
    push_ptr("    push_u64(0);\0\0\0\0");
    mw__3B_();
    ...
    push_ptr("  }\0\0\0\0");
    mw__3B_();
    push_ptr("  usize new_size = (usize)psize;\0\0\0\0");
    mw__3B_();
    push_ptr("  if ((vptr.tag == VT_C64) && !value_has_ptr_offset(vptr)) {\0\0\0\0");
    mw__3B_();
    push_ptr("     usize cell_index = get_cell_index(vptr);\0\0\0\0");
    mw__3B_();
    push_ptr("     cell_t *cell = heap + cell_index;\0\0\0\0");
    mw__3B_();
    push_ptr("     usize old_size = (usize)cell->car.payload.vp_u64;\0\0\0\0");
    mw__3B_();
    push_ptr("     void* old_ptr = cell->cdr.payload.vp_ptr;\0\0\0\0");
    mw__3B_();
    push_ptr("     void* new_ptr = realloc(old_ptr, new_size);\0\0\0\0");
    mw__3B_();
    push_ptr("     cell->car.payload.vp_i64 = psize;\0\0\0\0");
    mw__3B_();
    push_ptr("     cell->cdr.payload.vp_ptr = new_ptr;\0\0\0\0");
    mw__3B_();
    push_ptr("     if (old_size < new_size) {\0\0\0\0");
    mw__3B_();
    push_ptr("       memset((char*)new_ptr + old_size, 0, new_size - old_size);\0\0\0\0");
    mw__3B_();
    push_ptr("     }\0\0\0\0");
    mw__3B_();
    push_ptr("     push_value(vptr);\0\0\0\0");
    mw__3B_();
    push_ptr("  } else {\0\0\0\0");
    mw__3B_();
    push_ptr("    void* old_ptr = value_ptr(vptr);\0\0\0\0");
    mw__3B_();
    push_ptr("    usize old_size = (usize)value_ptr_size(vptr);\0\0\0\0");
    mw__3B_();
    push_ptr("    void* new_ptr = alloc_but_copy(new_size, old_ptr, old_size);\0\0\0\0");
    mw__3B_();
    push_ptr("    value_t vsize = { .tag = VT_U64, .payload = { .vp_i64 = psize } };\0\0\0\0");
    mw__3B_();
    push_ptr("    value_t vnew = { .tag = VT_U64, .payload = { .vp_ptr = new_ptr } };\0\0\0\0");
    mw__3B_();
    push_ptr("    value_t v = mkcell_freecdr(vsize, vnew);\0\0\0\0");
    mw__3B_();
    push_ptr("    push_value(v);\0\0\0\0");
    mw__3B_();
    push_ptr("    decref(vptr);\0\0\0\0");
    ...
    push_ptr(" {\0\0\0\0");
    mw__3B_();
    push_ptr("  value_t vdst = pop_value();\0\0\0\0");
    mw__3B_();
    push_ptr("  i64 ilen = pop_i64();\0\0\0\0");
    mw__3B_();
    push_ptr("  value_t vsrc = pop_value();\0\0\0\0");
    mw__3B_();
    push_ptr("  void* src = value_ptr(vsrc);\0\0\0\0");
    mw__3B_();
    push_ptr("  void* dst = value_ptr(vdst);\0\0\0\0");
    mw__3B_();
    push_ptr("  if (src && dst && (ilen > 0)) {\0\0\0\0");
    mw__3B_();
    push_ptr("    memcpy(dst, src, (usize)ilen);\0\0\0\0");
    mw__3B_();
    push_ptr("  }\0\0\0\0");
    mw__3B_();
    push_ptr("  decref(vsrc);\0\0\0\0");
    mw__3B_();
    push_ptr("  decref(vdst);\0\0\0\0");
    mw__3B_();
    push_ptr("}\0\0\0\0");
    mw__3B__3B_();
    mw_PRIM_PTR_FILL();
    ...
    push_ptr("  i64 ilen = pop_i64();\0\0\0\0");
    mw__3B_();
    push_ptr("  i64 val = pop_i64();\0\0\0\0");
    mw__3B_();
    push_ptr("  void* dst = value_ptr(vdst);\0\0\0\0");
    mw__3B_();
    push_ptr("  if (dst && (ilen > 0)) {\0\0\0\0");
    mw__3B_();
    push_ptr("    memset(dst, (int)val, (usize)ilen);\0\0\0\0");
    mw__3B_();
    push_ptr("  }\0\0\0\0");
    mw__3B_();
    push_ptr("  decref(vdst);\0\0\0\0");
    ...
    mw_PRIM_PTR_RAW();
    mw__2E_pm();
    push_ptr("do { usize i = stack_counter; push_ptr(value_ptr(stack[i])); } while(0)\0\0\0\0");
    mw__3B_();
    mw_PRIM_STR_EQ();
    mw__2E_p();
    push_ptr("{\0\0\0\0");
    mw__3B_();
    push_ptr("  value_t vptr1 = pop_value();\0\0\0\0");
    mw__3B_();
    push_ptr("  value_t vptr2 = pop_value();\0\0\0\0");
    mw__3B_();
    push_ptr("  const char* ptr1 = value_ptr(vptr1);\0\0\0\0");
    mw__3B_();
    push_ptr("  const char* ptr2 = value_ptr(vptr2);\0\0\0\0");
    mw__3B_();
    push_ptr("  bool result = (!ptr1 || !ptr2) ? (ptr1 == ptr2) : strcmp(ptr1,ptr2) == 0;\0\0\0\0");
    mw__3B_();
    push_ptr("  push_bool(result);\0\0\0\0");
    mw__3B_();
    push_ptr("  decref(vptr1); decref(vptr2);\0\0\0\0");
    mw__3B_();
    push_ptr("}\0\0\0\0");
    mw__3B__3B_();
    mw_PRIM_STR_ALLOC();
    ...
    push_ptr("  i64 psize = pop_i64();\0\0\0\0");
    mw__3B_();
    push_ptr("  push_i64(psize + 4);\0\0\0\0");
    mw__3B_();
    push_ptr("  mw_prim_ptr_alloc();\0\0\0\0");
    mw__3B_();
    push_ptr("}\0\0\0\0");
    mw__3B__3B_();
    mw_PRIM_STR_BASE();
    ...
    mw_PRIM_STR_SIZE();
    mw__2E_pm();
    push_ptr("do { value_t v = stack[stack_counter]; if (!v.payload.vp_u64) { push_u64(0); } else if (v.tag == VT_U64) { push_u64((u64)strlen(v.payload.vp_ptr)); } else { push_i64(value_ptr_size(v)-4); }  } while(0)\0\0\0\0");
    mw__3B__3B_();
    push_ptr("#define do_pack_cons() do { value_t cdr = pop_value(); value_t car = pop_value(); push_value(mkcell(car,cdr)); } while(0)\0\0\0\0");
    mw__3B_();
    mw_PRIM_PACK_NIL();
    mw__2E_pm();
    push_ptr(" push_u64(0)\0\0\0\0");
    ...
    mw_PRIM_MUT_NEW();
    mw__2E_pm();
    push_ptr("do { value_t car = pop_value(); value_t cdr = { 0 }; push_value(mkcell_raw(car,cdr)); } while(0)\0\0\0\0");
    mw__3B_();
    mw_PRIM_MUT_GET();
    mw__2E_pm();
    push_ptr("do { value_t mut = pop_value(); if (mut.tag == VT_U64 && mut.payload.vp_valueptr) { value_t val =*mut.payload.vp_valueptr; push_value(val); incref(val); } else { push_value(mut); do_pack_uncons(); pop_value(); } } while(0)\0\0\0\0");
    mw__3B_();
    mw_PRIM_MUT_SET();
    mw__2E_pm();
    push_ptr("do { value_t mut = pop_value(); value_t newval = pop_value(); push_value(mut); if (mut.tag == VT_U64 && mut.payload.vp_valueptr) { value_t oldval = *mut.payload.vp_valueptr; *mut.payload.vp_valueptr = newval; decref(oldval); } else { usize cellidx = get_cell_index(mut); if (cellidx) { cell_t* cell = heap + cellidx; value_t oldval = cell->car; cell->car = newval; decref(oldval); } else { decref(newval); } } } while(0)\0\0\0\0");
    mw__3B__3B_();
}
