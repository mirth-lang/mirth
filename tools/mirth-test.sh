...
C99FLAGS="-std=c99 -Wall -Wextra -Wno-unused-variable -Wno-unused-but-set-variable -Wno-unused-function -Wno-unused-parameter -Wno-unused-value -Wno-overlength-strings -Wno-sometimes-initialized -Werror -pedantic"
CC="gcc $C99FLAGS"
